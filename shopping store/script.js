...
function addProductToCart(title, price, productImg){
  ...
  for (let i = 0; i < cartItemsNames.length; i++) {
    if (cartItemsNames[i].innerText == title){
      alert("You have already added this item to cart! You can icrease or remove it inside the cart.");
      return;
    }
  }
  let cartBoxContent = `
                  ...
                  <div class="detail-box">
                    ...
                    <input type="number" title="quantity" value="1" class="cart-quantity">
                  </div>
...
function updateTotal(){
  ...
  let cartBoxes = carContent.getElementsByClassName("cart-box");
  let total = 0;
